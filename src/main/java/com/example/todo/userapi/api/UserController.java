...
public class UserController {
  ...
  public ResponseEntity<?> signup(
          ...
          //required = false는 사진 첨부 안해도 되서 넣었다.
  ...
  public ResponseEntity<?> loadFile(
    ...
    try {
      ...
      MediaType contentType = findExtensionAndetMediaType(filePath);
      if(contentType == null) {
  ...
  private MediaType findExtensionAndetMediaType(String filePath) {
  ...
  @PreAuthorize("hasRole('ROLE_COMMON')")// ROLE_COMMON이 아니면 예외발생하여 코드 발생하지않음.
